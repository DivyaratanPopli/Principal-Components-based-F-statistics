...
\begin{figure}[ht!]
    ...
    \centering
    \caption{Comparison of PPCA and LSE to ADMIXTOOLS 2 in presence of 50\% random missingness, using population genotypes from one individual from each population.}
    \label{figS2:pc_scale}
\end{figure}


\subsection{Admixture with $F_3$ and $F_4$}
