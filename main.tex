...
We evaluate the performance of PCA, PPCA and LSE frameworks and compare to that of admixtools 2. We first evaluate the performance of these methods on simulations, and then on a neandertal dataset.   
...
\begin{figure}[ht!]
    ...
    \centering
    \caption{Comparison of PPCA and LSE to ADMIXTOOLS 2 using population genotypes from ten individuals in each population. X-axis shows the number of PC's used for the three methods, ranging from 2 to 50.}
    \label{figS2:pc_scale}
\end{figure}
